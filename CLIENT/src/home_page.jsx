  ...
  return (
    <>
      <div className={home_style.container}>
        ...
        <div className={home_style.main_container}>
          <div className={home_style.main_text}>
            ...
            <button className={home_style.button}>바로가기</button>
          </div>
        </div>
      </div>
      <div className={home_style.sec_container}>
        <div className={home_style.sec_wrapper}>
          <div className={home_style.sec_image}></div>
          <div className={home_style.text_wrapper}>
            <h2>친구들과 채팅</h2>
            <p>
              어쩌구 저쩌구 버니톡 정말 좋아요
              <br />
      ...
      <div
        className={home_style.sec_container}
      ...
      <div className={home_style.sec2_container}>
        <div className={home_style.sec2_wrapper}>
          <button className={home_style.button}>나만의 공간 만들러 가기</button>
        </div>
      </div>
      <footer>
        <div className={home_style.footer_wrapper}>
          <span className={home_style.text}>
